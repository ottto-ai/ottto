...
grep -q "min_protocol_version must be 14" /tmp/macos-public-rc-template.out
...
grep -q "stable-candidate manifest min_protocol_version must be 14" /tmp/macos-public-rc-gate.out
...
grep -q "stable manifest min_protocol_version must be 14" /tmp/macos-public-rc-gate.out
...
grep -q "local_platform.protocol_version must be 14" /tmp/macos-public-rc-gate.out
